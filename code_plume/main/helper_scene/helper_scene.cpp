...
void load_shaders(std::map<std::string,GLuint>& shaders)
{
    ...
    shaders["mesh_transition"] = create_shader_program("scenes/shared_assets/shaders/mesh_transition/shader.vert.glsl", "scenes/shared_assets/shaders/mesh_transition/shader.frag.glsl");
