...
public:
    ...
    mesh_drawable(const mesh& mesh_cpu, GLuint shader = 0, GLuint texture_id = 0, GLuint norm_tex_id_arg = 0);
    ...
    void draw(const camera_scene& camera, GLuint shader, GLuint texture_id, GLuint norm_tex_id = 0);
