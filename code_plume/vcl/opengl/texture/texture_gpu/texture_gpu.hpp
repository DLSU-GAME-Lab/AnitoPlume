...
GLuint add_normal_map(image_raw const& im, GLint wrap_s = GL_CLAMP_TO_EDGE, GLint wrap_t = GL_CLAMP_TO_EDGE);
GLuint add_normal_map(std::vector<unsigned char> const& data, GLsizei width, GLsizei height, GLint wrap_s = GL_CLAMP_TO_EDGE, GLint wrap_t = GL_CLAMP_TO_EDGE);
